        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8 shadow-2xl w-full max-w-md">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Access your secure manufacturing portal</p>
              </div>
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-xs text-gray-600">
              Used by 500+ manufacturers worldwide • ITAR compliant facility
            </p>
          </div>
        </div>
      </main>
