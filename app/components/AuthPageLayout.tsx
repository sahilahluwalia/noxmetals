        ...
        <div className="w-full max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8">
            ...
            <div className="w-full max-w-4xl">
              ...
              {/* Source Code Link */}
              <div className="mt-4 bg-purple-900/20 border border-purple-700/30 rounded-lg p-4 max-w-2xl mx-auto">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                  </svg>
                  <div>
                    <h4 className="text-sm font-medium text-purple-300 mb-1">Open Source Project</h4>
                    <p className="text-xs text-purple-200 mb-2">
                      This is a full-stack remake with enhanced features. View the complete source code (majorly written with AI for fast prototyping)
                    </p>
                    <a 
                      href="https://github.com/sahilahluwalia/noxmetals" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-xs text-purple-300 hover:text-purple-200 transition-colors underline decoration-purple-500/50 hover:decoration-purple-400"
                    >
