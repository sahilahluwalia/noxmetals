...
export default function QuoteApprovedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Great news! Your quote #{quoteId} has been approved by Nox Metals</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              Excellent news! Your quote request has been <strong>approved</strong> by our team at Nox Metals.
            </Text>
            ...
            <Section style={ctaSection}>
              ...
              <Button style={button} href={`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/quotes`}>
                View Quote Details
              </Button>
            </Section>
            ...
            <Text style={footer}>
              Thank you for choosing Nox Metals for your manufacturing needs. If you have any questions, 
